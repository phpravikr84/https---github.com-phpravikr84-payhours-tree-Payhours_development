...
class PayBatchNumberController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('administrator.setting.pay_batch_numbers.index')->with('success', 'Pay Batch Number updated successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('administrator.setting.pay_batch_numbers.index')->with('success', 'Pay Batch Number deleted successfully.');
    }
}
