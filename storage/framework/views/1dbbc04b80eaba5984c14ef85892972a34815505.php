<?php $__env->startSection('title', __('Pay Reference Details')); ?>

<?php $__env->startSection('main_content'); ?>
<div class="content-wrapper">
    <section class="content-header">
        <h1><?php echo __('Pay Reference Details'); ?></h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo url('/dashboard'); ?>"><i class="fa fa-dashboard"></i> <?php echo __('Dashboard'); ?></a></li>
            <li><a href="<?php echo route('pay_references.index'); ?>"><?php echo __('Pay References'); ?></a></li>
            <li class="active"><?php echo __('Pay Reference Details'); ?></li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo __('Manage Pay Reference Details'); ?></h3>
            </div>
            ...
            <table class="table table-bordered table-striped">
                    <tbody>
                        <?php $__currentLoopData = $pay_references; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pay_reference): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td>ID: <?php echo $pay_reference->id; ?></td>
                                <td><?php echo __('Pay Reference Name'); ?> : <?php echo $pay_reference->pay_reference_name; ?></td>
                                <td><?php echo __('Pay Period Start Date'); ?> : <?php echo $pay_reference->pay_period_start_date; ?></td>
                                <td><?php echo __('Pay Period End Date'); ?> : <?php echo $pay_reference->pay_period_end_date; ?></td>
                                <td><?php echo __('Branch'); ?> : <?php echo $pay_reference->branch_name; ?></td>
                                <td><?php echo __('Pay Batch'); ?> : <?php echo $pay_reference->payroll_number; ?></td>
                            </tr>
