    ...
    <section class="content">
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title">{{ __('Wpac Bank Transfer Setup') }}</h3>
            </div>
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 px-4">
                        <h5>{{ __('Wpac Bank Transfer Settings') }}</h5>
                        <form action="{{ route('wpac_bank_transfer_setups_store') }}" method="POST">
                            {{ csrf_field() }}
