    ...
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="#"><i class="fa fa-circle-o"></i>{{ __('System Control File') }}</a></li>
                        <li><a href="#"><i class="fa fa-circle-o"></i>{{ __('Bank Listing') }}</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="#"><i class="fa fa-circle-o"></i>{{ __('Pay Batch Number') }}</a></li>
                        <li><a href="#"><i class="fa fa-circle-o"></i>{{ __('Pay Location') }}</a></li>
                        <li><a href="#"><i class="fa fa-circle-o"></i>{{ __('GL Codes') }}</a></li>
                        <li><a href="#"><i class="fa fa-circle-o"></i>{{ __('Pay Accumulators') }}</a></li>
                        <li><a href="#"><i class="fa fa-circle-o"></i>{{ __('Superannuation') }}</a></li>
                        <li><a href="{{ route('setting.bank_details.index') }}"><i class="fa fa-circle-o"></i>{{ __('Bank Details') }}</a></li>
                        <li><a href="#"><i class="fa fa-circle-o"></i>{{ __('Period Definition') }}</a></li>
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                ...
                <!-- <li><a href="{{ url('/hrm/attendance/report') }}"><i class="fa fa-circle-o"></i>{{ __(' Attendance History') }}</a></li> -->
                @endpermission
            </ul>
        </li>
        @endpermission
       ...
       @permission('file-upload')
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                ...
                <li><a href="{{ url('/setting/shifts') }}"><i class="fa fa-circle-o"></i> {{ __('Set Working Hours') }}</a></li>
